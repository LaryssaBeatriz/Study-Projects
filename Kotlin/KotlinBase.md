...
- [Funções](#funcoes) 
- [Funções Empty e Blank](#funcoes-empty-e-blank)
- [Funções de ordem superior](#funcoes-de-ordem-superior)
- [Funções single-line](#funcoes-single-line)
- [Funções/Extensões](#funcoes/extensoes)
- [Estruturas de controle](#estruturas-de-controle)
- [If/else](#if/else)
- [When](#when)
- [Elvis Operator](#elvis-operator)
- [Atribuição usando estruturas de controle](#atribuicao-usando-essas-estruturas)
